            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                <div className="flex flex-col md:flex-row justify-between items-start gap-16">
                    <div className="space-y-8 max-w-sm">
                        ...
                        <p className="text-ghost/40 font-light leading-relaxed">
                            Breaking the boundaries of visual excellence. Digital-first, Soul-driven. Worldwide.
                        </p>
                        <div className="flex gap-6">
                            <Instagram className="w-5 h-5 text-purple/40 hover:text-cyan transition-colors cursor-pointer" />
                            <Twitter className="w-5 h-5 text-purple/40 hover:text-cyan transition-colors cursor-pointer" />
                            <Linkedin className="w-5 h-5 text-purple/40 hover:text-cyan transition-colors cursor-pointer" />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-16 md:gap-24">
                        <div className="space-y-6">
                            ...
                            <ul className="space-y-4 text-sm text-ghost/40 font-light">
                ...
                <div className="mt-24 pt-8 border-t border-purple/5 flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-xs uppercase tracking-[0.2em] text-ghost/20">
