...
const About = () => {
    ...
    return (
        <main className="min-h-screen bg-obsidian text-ghost pt-32 pb-24 font-light">
            ...
            <section className="px-6 md:px-12 max-w-7xl mx-auto mb-32 flex flex-col lg:flex-row gap-16 items-center">
                <div className="lg:w-1/2">
                    ...
                    <motion.div
                        ...
                        className="space-y-6 text-ghost/70 leading-relaxed text-lg"
                    >
                        <p>
            ...
            {/* Core Values */}
            <section className="bg-forest py-24 px-6 md:px-12 border-y border-emerald/10">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl font-serif tracking-widest uppercase mb-4 text-ghost">Core <span className="text-amber italic">Values</span></h2>
                        ...
                        {values.map((item, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="p-8 border border-emerald/5 hover:border-emerald/20 transition-colors duration-500 bg-obsidian/30 backdrop-blur-sm rounded"
                                >
                                    ...
                                    <p className="text-ghost/60">{item.description}</p>
                                </motion.div>
                            )
                        })}
                    </div>
            ...
            <section className="py-32 px-6 md:px-12 max-w-7xl mx-auto text-center">
                <motion.div
                    ...
                    transition={{ duration: 0.8 }}
                >
                    <p className="text-emerald text-sm uppercase tracking-widest mb-4">The Artist</p>
                    <h2 className="text-5xl font-serif tracking-wider mb-8">Elias <span className="italic text-amber font-light">Thorne</span></h2>
                    <p className="max-w-2xl mx-auto text-ghost/70 leading-relaxed mb-12">
